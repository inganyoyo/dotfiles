...
jq '
  ...
  .context_window.total_input_tokens = (.context_window.total_input_tokens // .context.total_input_tokens // .tokens // empty) |
  .cost.total_cost_usd = (.cost.total_cost_usd // .cost.total_cost // .cost // empty) |
